...
const (
	...
	AuthService_SendEmailVerification_FullMethodName = "/auth.AuthService/SendEmailVerification"
	AuthService_EmailVerify_FullMethodName           = "/auth.AuthService/EmailVerify"
)
...
const (
	PermissionService_GetUserPermissions_FullMethodName = "/auth.PermissionService/GetUserPermissions"
	PermissionService_HasUserPermission_FullMethodName  = "/auth.PermissionService/HasUserPermission"
)
