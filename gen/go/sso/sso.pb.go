...
const file_sso_sso_proto_rawDesc = "" +
	"\n" +
	"\rsso/sso.proto\x12\x04auth\x1a\x1bbuf/validate/validate.proto\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\xcb\x01\n" +
	...
	"\aallowed\x18\x01 \x01(\bR\aallowed2\xae\x0f\n" +
	"\vAuthService\x12\xe9\x01\n" +
	...
	"\x04Auth\x12\x1fEmail verification confirmation\x1a3Email will be verified after the token is confirmed\x82\xd3\xe4\x93\x02'\x12%/v1/auth/verification/confirm/{token}2\xf6\x03\n" +
	"\x11PermissionService\x12\xd3\x01\n" +
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	14, // 7: auth.AuthService.SendEmailVerification:input_type -> auth.SendEmailVerificationRequest
	16, // 8: auth.AuthService.EmailVerify:input_type -> auth.EmailVerifyRequest
	18, // 9: auth.PermissionService.GetUserPermissions:input_type -> auth.GetUserPermissionsRequest
	20, // 10: auth.PermissionService.HasUserPermission:input_type -> auth.HasUserPermissionRequest
	...
	13, // 17: auth.AuthService.ResetPassword:output_type -> auth.ResetPasswordResponse
	15, // 18: auth.AuthService.SendEmailVerification:output_type -> auth.SendEmailVerificationResponse
	17, // 19: auth.AuthService.EmailVerify:output_type -> auth.EmailVerifyResponse
	19, // 20: auth.PermissionService.GetUserPermissions:output_type -> auth.GetUserPermissionsResponse
	21, // 21: auth.PermissionService.HasUserPermission:output_type -> auth.HasUserPermissionResponse
