...
const file_profile_v1_profile_proto_rawDesc = "" +
	...
	"profile.v1\x1a\x1bbuf/validate/validate.proto\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x86\x02\n" +
	...
	"\aprofile\x18\x01 \x01(\v2\x17.profile.v1.UserProfileR\aprofile\"\xa6\x01\n" +
	"\x14ListProfilesResponse\x123\n" +
	"\bprofiles\x18\x01 \x03(\v2\x17.profile.v1.UserProfileR\bprofiles\x12\x14\n" +
	"\x05total\x18\x02 \x01(\x03R\x05total\x12\x12\n" +
	"\x04page\x18\x03 \x01(\x03R\x04page\x12\x14\n" +
	"\x05limit\x18\x04 \x01(\x03R\x05limit\x12\x19\n" +
	"\bhas_next\x18\x05 \x01(\bR\ahasNext2\x8d\n" +
	"\n" +
	"\x0eProfileService\x12\xbe\x01\n" +
	"\rCreateProfile\x12 .profile.v1.CreateProfileRequest\x1a\x1b.profile.v1.ProfileResponse\"n\x92AT\n" +
	"\aProfile\x12\x13Create user profile\x1a4Creates user profile by the data input automatically\x82\xd3\xe4\x93\x02\x11:\x01*\"\f/v1/profiles\x12\xef\x01\n" +
	"\n" +
	"GetProfile\x12\x1d.profile.v1.GetProfileRequest\x1a\x1b.profile.v1.ProfileResponse\"\xa4\x01\x92A\x87\x01\n" +
	"\aProfile\x12 Get user profile by id (profile)\x1aZGet user profile by profile id (string UUID) (important to not mix with user_id from auth)\x82\xd3\xe4\x93\x02\x13\x12\x11/v1/profiles/{id}\x12\xee\x01\n" +
	"\x12GetProfileByUserID\x12%.profile.v1.GetProfileByUserIDRequest\x1a\x1b.profile.v1.ProfileResponse\"\x93\x01\x92Aj\n" +
	"\aProfile\n" +
	"\x04Auth\x12\"Get user profile by user_id (auth)\x1a5Get user profile by user_id from auth service (int64)\x82\xd3\xe4\x93\x02 \x12\x1e/v1/profiles/by-user/{user_id}\x12\xd7\x01\n" +
	"\rUpdateProfile\x12 .profile.v1.UpdateProfileRequest\x1a\x1b.profile.v1.ProfileResponse\"\x86\x01\x92Ag\n" +
	"\aProfile\n" +
	"\x04Auth\x12\x19Update user profile PATCH\x1a;Update user profile partially or fully depending on request\x82\xd3\xe4\x93\x02\x16:\x01*2\x11/v1/profiles/{id}\x12\xc0\x01\n" +
	"\rDeleteProfile\x12 .profile.v1.DeleteProfileRequest\x1a!.profile.v1.DeleteProfileResponse\"j\x92AN\n" +
	"\aProfile\x12\x13Delete user profile\x1a.Delete user profile by UUID profile id string \x82\xd3\xe4\x93\x02\x13*\x11/v1/profiles/{id}\x12\xb9\x01\n" +
	"\fListProfiles\x12\x1f.profile.v1.ListProfilesRequest\x1a .profile.v1.ListProfilesResponse\"f\x92AO\n" +
	"\aProfile\x12\x1aList profiles (for admins)\x1a(List profiles by limiting and pagination\x82\xd3\xe4\x93\x02\x0e\x12\f/v1/profilesB\xd1\x02\x92A\xae\x01\x12\x84\x01\n" +
	...
	"\x0ecom.profile.v1B\fProfileProtoP\x01Z6github.com/m4rk1sov/protos/gen/go/profile/v1;profilev1\xa2\x02\x03PXX\xaa\x02\n" +
	"Profile.V1\xca\x02\n" +
...
var file_profile_v1_profile_proto_goTypes = []any{
	...
	(*GetProfileByUserIDRequest)(nil), // 3: profile.v1.GetProfileByUserIDRequest
	(*UpdateProfileRequest)(nil),      // 4: profile.v1.UpdateProfileRequest
	(*DeleteProfileRequest)(nil),      // 5: profile.v1.DeleteProfileRequest
	(*DeleteProfileResponse)(nil),     // 6: profile.v1.DeleteProfileResponse
	(*ListProfilesRequest)(nil),       // 7: profile.v1.ListProfilesRequest
	(*ProfileResponse)(nil),           // 8: profile.v1.ProfileResponse
	(*ListProfilesResponse)(nil),      // 9: profile.v1.ListProfilesResponse
	(*timestamppb.Timestamp)(nil),     // 10: google.protobuf.Timestamp
}
var file_profile_v1_profile_proto_depIdxs = []int32{
	10, // 0: profile.v1.UserProfile.created_at:type_name -> google.protobuf.Timestamp
	10, // 1: profile.v1.UserProfile.updated_at:type_name -> google.protobuf.Timestamp
	0,  // 2: profile.v1.ProfileResponse.profile:type_name -> profile.v1.UserProfile
	0,  // 3: profile.v1.ListProfilesResponse.profiles:type_name -> profile.v1.UserProfile
	...
	3,  // 6: profile.v1.ProfileService.GetProfileByUserID:input_type -> profile.v1.GetProfileByUserIDRequest
	4,  // 7: profile.v1.ProfileService.UpdateProfile:input_type -> profile.v1.UpdateProfileRequest
	5,  // 8: profile.v1.ProfileService.DeleteProfile:input_type -> profile.v1.DeleteProfileRequest
	7,  // 9: profile.v1.ProfileService.ListProfiles:input_type -> profile.v1.ListProfilesRequest
	8,  // 10: profile.v1.ProfileService.CreateProfile:output_type -> profile.v1.ProfileResponse
	8,  // 11: profile.v1.ProfileService.GetProfile:output_type -> profile.v1.ProfileResponse
	8,  // 12: profile.v1.ProfileService.GetProfileByUserID:output_type -> profile.v1.ProfileResponse
	8,  // 13: profile.v1.ProfileService.UpdateProfile:output_type -> profile.v1.ProfileResponse
	6,  // 14: profile.v1.ProfileService.DeleteProfile:output_type -> profile.v1.DeleteProfileResponse
	9,  // 15: profile.v1.ProfileService.ListProfiles:output_type -> profile.v1.ListProfilesResponse
